...
var map = {
	"./pages/cart-modal/cart-modal.module": "./src/app/pages/cart-modal/cart-modal.module.ts"
};
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _pages_cart_modal_cart_modal_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pages/cart-modal/cart-modal.module */ "./src/app/pages/cart-modal/cart-modal.module.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            entryComponents: [],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"], _pages_cart_modal_cart_modal_module__WEBPACK_IMPORTED_MODULE_1__["CartModalPageModule"]],
            providers: [
...
var CartModalPage = /** @class */ (function () {
    ...
    CartModalPage.prototype.getTotal = function () {
        return this.cart.reduce(function (i, j) { return i + j.point * j.amount; }, 0);
    };
    CartModalPage.prototype.close = function () {
        this.modalCtrl.dismiss();
    };
    CartModalPage.prototype.checkout = function () {
    };
    ...
    CartModalPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_cart_service__WEBPACK_IMPORTED_MODULE_1__["CartService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"]])
    ], CartModalPage);
...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.decreaseProduct = function (product) {
        for (var _i = 0, _a = this.cart.entries(); _i < _a.length; _i++) {
            var _b = _a[_i], index = _b[0], p = _b[1];
            if (p.id === product.id) {
                p.amount -= 1;
                if (p.amount == 0) {
...
module.exports = __webpack_require__(/*! c:\Users\Reginaldo\Documents\projetosIonic\devdactic-ionic-4-shopping-cart\src\main.ts */"./src/main.ts");
